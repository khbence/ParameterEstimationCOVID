...
avg_grp_1 = [0.2103    0.1678    0.1023    0.1052    0.1203    0.0944    0.0889    0.0914];
std_grp_1 = [0.0170    0.0136    0.0076    0.0073    0.0081    0.0081    0.0067    0.0067];
%%Wave 2
%    'Age group distribution'
...
avg_grp_2 = [0.4184    0.3996    0.1984    0.2320    0.2665    0.1273    0.1137    0.1085];
std_grp_2 = [0.0251    0.0181    0.0100    0.0124    0.0137    0.0105    0.0081    0.0087];

        figure; %4B
		scenarionames = {'Autumn wave';'Spring wave'};
        angle = 45;
        ...
        xticklabels({'0-5','6-14','15-18','19-30','31-62','63-70','71-80','81-'});
        set(h, {'DisplayName'}, scenarionames);
        hold on
        x_errorbar = zeros(1, numel(sdmat));
        for i = 1 : size(avmat,1)
