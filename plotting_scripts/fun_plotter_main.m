function output = fun_plotter_main(std_ip,agst_ip,tr_ip,scen_names,Title,Measures,StartDate,...
    ...
    if std_flag == 1
        fun_plotter_std(std_ip,scen_names,Title,Measures,StartDate,rdata_flag,Path,'No. of Agents',colors,begintint,agst_ip,ctw_flag)
        fun_plotter_std(std_ip,scen_names,Title,Measures,StartDate,rdata_flag,Path,'Ratio to Total Population (%)',colors,begintint,agst_ip,ctw_flag)
